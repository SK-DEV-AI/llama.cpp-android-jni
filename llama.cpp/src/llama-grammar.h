...
struct llama_grammar {
    ...
    // buffer for characters that were partially matched but not fully accepted by grammar
    // this allows tokens like "{T" to be partially accepted when grammar only expects "{"
    std::string partial_match_buffer;
